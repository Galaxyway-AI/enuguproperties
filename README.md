...
Photos are content-decoded with Sharp, resized to 2400 px and converted to WebP without EXIF. Evidence accepts images or flat PDFs up to 12 MB. PDF active-feature rejection is a preliminary check, not a malware scanner; deploy malware scanning before accepting untrusted production documents at scale.
